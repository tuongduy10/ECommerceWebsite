...
namespace ECommerce.Application.BaseServices.Shop
{
    public class ShopService : IShopService
    {
        ...
        public async Task<ApiResponse> AddShop(ShopAddRequest request)
        {
            try
            {
                ...
                Data.Entities.ProductSchema.Shop shop = new Data.Entities.ProductSchema.Shop();
                ...
                if (request.brandIds.Count > 0)
                {
                    ...
                    {
                        ShopBrand brand = new Data.Entities.ProductSchema.ShopBrand
                        {
                            BrandId = id,
                            ShopId = shop.ShopId
                        };
        ...
        public async Task<ApiResponse> SaleRegistration(SaleRegistrationRequest request)
        {
            ...
            ShopBank bank = new Data.Entities.ProductSchema.ShopBank();
        ...
        public async Task<ApiResponse> updateShop(ShopUpdateRequest request)
        {
            try
            {
                ...
                if (bank == null)
                {
                    ...
                    var newBank = new Data.Entities.ProductSchema.ShopBank
                    {
                ...
                if (request.shopBrands != null)
                {
                    ...
                    {
                        var brand = new Data.Entities.ProductSchema.ShopBrand
                        {
                            BrandId = id,
                            ShopId = shop.ShopId
                        };
